...
@pytest.mark.parametrize(
    "dict_a, dict_b, expected", [
        ...
        ({'block_name': 'a', 'extends': 'b', 'param1': '0', 'block_idx': 0},
         {'block_name': 'b', 'extends': 'c', 'param2': '0', 'block_idx': 1, 'param3': '0'},
         {'block_name': 'a', 'extends': 'b', 'param1': '0', 'param2': '0', 'param3': '0', 'block_idx': 0}),
